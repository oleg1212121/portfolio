...
class TranslatorService
{
    ...
    {
        $url = 'https://dictionary.yandex.net/api/v1/dicservice.json/lookup?text=' . $word . '&lang='.static::LANG.'&key='. static::YANDEX_DICTIONARY_KEY;
    ...
    public static function getYandexApiTranslate(array $words = []) :array
    {
        ...
        $url = 'https://translate.yandex.net/api/v1.5/tr.json/translate?format=plain&text='
            . $text . '&lang=' . static::LANG . '&key=' . static::YANDEX_API_KEY;
